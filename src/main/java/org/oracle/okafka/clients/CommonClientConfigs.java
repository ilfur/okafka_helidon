...
public class CommonClientConfigs {
    ...
    public static final String ORACLE_USER_NAME_DOC = "Oracle DB user to connect to.";
    public static final String ORACLE_PASSWORD ="oracle.password";
    public static final String ORACLE_PASSWORD_DOC = "Oracle DB user'S password to connect to";
