...
import static org.oracle.okafka.clients.admin.AdminClientConfig.ORACLE_PASSWORD;
import static org.oracle.okafka.clients.admin.AdminClientConfig.ORACLE_USER_NAME;
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG, Type.LIST, Collections.emptyList(), new ConfigDef.NonNullValidator(), Importance.HIGH, CommonClientConfigs.BOOTSTRAP_SERVERS_DOC)
                                ...
                                .define(ORACLE_USER_NAME,
                                		...
                                		"",
                                		Importance.HIGH,
                                		CommonClientConfigs.ORACLE_USER_NAME_DOC) 
                                .define(ORACLE_PASSWORD,
                                		Type.STRING,
                                		"",
                                		Importance.HIGH,
                                		CommonClientConfigs.ORACLE_PASSWORD_DOC) 
